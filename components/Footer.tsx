...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden border-t-2 border-brand-magenta/20 bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="pointer-events-none absolute inset-0 z-0 flex items-center justify-center">
        <Image
          ...
          width={900}
          height={280}
          className="h-auto w-[900px] object-contain opacity-[0.039]"
        />
      </div>
        ...
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
          ...
          <div>
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-gray-500">
              We build brands, create experiences and bring people together -
              across cities and beyond.
            </p>
          </div>
